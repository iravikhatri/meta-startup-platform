...
export default function StageIcon({ height, width, className }) {
    return (
        <svg className={className} height={height} width={width} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16.253 16.253">
