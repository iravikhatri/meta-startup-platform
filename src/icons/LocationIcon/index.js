...
export default function LocationIcon({ height, width, className }) {
    return (
        <svg className={className} height={height} width={width} enableBackground="new 0 0 24 24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
