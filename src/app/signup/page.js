    ...
    return (
        <div className="flex justify-center">
            <div className="h-auto w-1/3 my-6">
                <div className="mb-5">
                    <h2 className="text-2xl text-gray-800 font-medium leading-tight">Create a new account</h2>
                    <p className="text-gray-600 font-medium leading-tight">... and let's start a new journey of startup world</p>
                </div>
                <form className="mb-4">
                    <div className="grid grid-cols-2 gap-5">
                        <div className="mb-3">
                            <label className={styleClass.inputLabel} htmlFor="first_name">First Name</label>
                            <input className={styleClass.input} type="text" id="first_name" autoComplete="chrome-off" />
                        </div>
                        <div className="mb-3">
                            <label className={styleClass.inputLabel} htmlFor="last_name">Last Name</label>
                            <input className={styleClass.input} type="text" id="last_name" autoComplete="chrome-off" />
                        </div>
                    </div>
                    <div className="mb-3">
                ...
                <div className='mb-3 text-center'>
                    Already have an account? <Link href="/login"><span className="text-gray-800 font-bold">Login</span></Link>
                </div>
                <div className='mb-3 text-center flex items-center justify-center or-line'>
